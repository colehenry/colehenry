...
S1_ACTIVITIES = (
    ...
    Activity("s1_vocab_lesson", "Learn 8 core words", "vocabulary", 15, "drill", format="vocab_lesson", target="recognize · listen · context · produce",
...
S3_ACTIVITIES = (
    ...
    Activity("s3_vocab_lesson", "Learn 8 core words", "vocabulary", 15, "drill", format="vocab_lesson", target="recognize · listen · context · produce",
             params={"count": 8, "only_sprint_vocab": True}, dims={"vocabulary": 1}),
